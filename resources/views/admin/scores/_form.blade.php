...
<div class="row clearfix">
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        @include('components.form.select', ['name' => 'archer_id', 'label' => 'Select Archer', 'search_enabled' => true, 'options' => $users, 'option_value' => 'id', 'option_name' => 'name'])
    </div>
    <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
        @include('components.form.select', ['name' => 'scorer_id', 'label' => 'Select Scorer', 'search_enabled' => true, 'options' => $users, 'option_value' => 'id', 'option_name' => 'name'])
    </div>
</div>
