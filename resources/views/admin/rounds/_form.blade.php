...
<div class="row cleafix">
    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
        @include('components.form.input.radio', ['id' => 'outdoor_radio', 'name' => 'season', 'label' => 'Outdoor', 'colour' => 'deep-orange', 'checked' => true])
        @include('components.form.input.radio', ['id' => 'indoor_radio', 'name' => 'season', 'label' => 'Indoor', 'colour' => 'deep-orange'])
    </div>
    <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
