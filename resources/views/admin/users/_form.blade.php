...
<div class="row clearfix">
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        @include('components.form.input.email', ['name' => 'email_address', 'label' => 'Email Address', 'value' => isset($user)? $user->email_address:null ])
    </div>
    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
        @include('components.form.input.text', ['name' => 'phone_number', 'label' => 'Phone Number', 'value' => isset($user)? $user->phone_number:null ])
    </div>
</div>
